...
class AccessTokenEndpoint(Resource):
    ...
    def post(self):
        ...
        '''
        ++ 1. We need to query the database for a user matching a username
           ++ - If user doesn't exist, throw and error and terminate early.
         2. Check that the password matches:
            - If password doesn't match, throw and error and terminate early.
        3. If we get here, we know the user is legit. Give them and access token
            and a refresh token
        '''
